...
public abstract class Hilt_LandingScreenFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LandingScreenFragment_GeneratedInjector) this.generatedComponent()).injectLandingScreenFragment(UnsafeCasts.<LandingScreenFragment>unsafeCast(this));
    }
  }
