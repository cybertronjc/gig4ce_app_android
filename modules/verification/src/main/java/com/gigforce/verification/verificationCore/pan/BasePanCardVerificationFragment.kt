package com.gigforce.verification.verificationCore.pan
...
import com.gigforce.verification.mainverification.pancard.PanCardViewModel
...
@AndroidEntryPoint
abstract class BasePanCardVerificationFragment(
    fragmentName: String
) : BaseFragment2<PanCardFragmentBinding>(
    fragmentName = fragmentName,
    layoutId = R.layout.pan_card_fragment,
    ...
    override fun viewCreated(
        viewBinding: PanCardFragmentBinding,
...
//                        }
    ...
    private fun listeners() {
        ...
        viewBinding.submitButton.setOnClickListener {
            ...
            if (shouldUploadDocumentsToFirebase()) {
...
//                navigation.popBackStack()
    ...
    private fun callKycOcrApi(path: Uri) {
        ...
        image?.let {
            ...
            viewModel.getKycOcrResult("pan", "dsd", it, getUserId())
        }
    }
...
//            Data("dob", viewBinding.dateOfBirth.text.toString())
        ...
        activeLoader(true)
        viewModel.getKycVerificationResult("pan", list, getUserId())
