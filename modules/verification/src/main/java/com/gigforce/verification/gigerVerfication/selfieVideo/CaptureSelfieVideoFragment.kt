...
class CaptureSelfieVideoFragment : Fragment() {
    ...
    ) = inflater.inflate(R.layout.fragment_add_selfie_capture_video, container,false)
    ...
    private fun initCamera() {
        ...
        Log.d("Logger", "CaptureSelfieVideoFragment : Camera Initiated")
    }
