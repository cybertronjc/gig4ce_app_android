package com.gigforce.verification.verificationCore.bank
...
import com.gigforce.verification.mainverification.bankaccount.BankAccountViewModel
...
@AndroidEntryPoint
abstract class BaseBankAccountVerificationFragment constructor(
    fragmentName: String
) : BaseFragment2<BankAccountFragmentBinding>(
    ...
    override fun viewCreated(
        viewBinding: BankAccountFragmentBinding,
...
//        viewModel.getBankVerificationUpdation()
        viewModel.getBankDetailsStatus(getUserId())
...
//                navigation.popBackStack()
        ...
        viewBinding.confirmButton.setOnClickListener {
            ...
            viewModel.setVerificationStatusInDB(true, getUserId())
        ...
        viewBinding.notConfirmButton.setOnClickListener {
            MaterialAlertDialogBuilder(requireContext())
                ...
                .setPositiveButton(getString(R.string.yes_veri)) { _, _ ->
                    ...
                    viewModel.setVerificationStatusStringToBlank(getUserId())
                }
    ...
    private fun callKycOcrApi(path: Uri) {
        ...
        image?.let {
            ...
            viewModel.getKycOcrResult("bank", "dummy", it, getUserId())
        }
    }
...
//                Log.d("ImageUri", imageUriResultCrop.toString())
    ...
    private fun callKycVerificationApi() {
        ...
        viewModel.getKycVerificationResult("bank", list, getUserId())
    }
