...
public abstract class Hilt_AadhaarUpload extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AadhaarUpload(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AadhaarUpload_GeneratedInjector) this.generatedComponent()).injectAadhaarUpload(UnsafeCasts.<AadhaarUpload>unsafeCast(this));
    }
  }
