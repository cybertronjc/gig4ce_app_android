...
public abstract class Hilt_GigerVerificationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GigerVerificationFragment() {
    super();
  }

  Hilt_GigerVerificationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GigerVerificationFragment_GeneratedInjector) this.generatedComponent()).injectGigerVerificationFragment(UnsafeCasts.<GigerVerificationFragment>unsafeCast(this));
    }
  }
