...
public abstract class Hilt_BankUpload extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BankUpload(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BankUpload_GeneratedInjector) this.generatedComponent()).injectBankUpload(UnsafeCasts.<BankUpload>unsafeCast(this));
    }
  }
