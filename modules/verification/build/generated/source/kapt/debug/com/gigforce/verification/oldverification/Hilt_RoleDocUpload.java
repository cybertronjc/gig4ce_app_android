...
public abstract class Hilt_RoleDocUpload extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RoleDocUpload(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoleDocUpload_GeneratedInjector) this.generatedComponent()).injectRoleDocUpload(UnsafeCasts.<RoleDocUpload>unsafeCast(this));
    }
  }
