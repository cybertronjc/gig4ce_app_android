...
public abstract class Hilt_VerificationDone extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerificationDone_GeneratedInjector) this.generatedComponent()).injectVerificationDone(UnsafeCasts.<VerificationDone>unsafeCast(this));
    }
  }
