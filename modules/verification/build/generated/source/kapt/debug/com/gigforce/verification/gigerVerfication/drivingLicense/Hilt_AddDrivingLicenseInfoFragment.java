...
public abstract class Hilt_AddDrivingLicenseInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddDrivingLicenseInfoFragment() {
    super();
  }

  Hilt_AddDrivingLicenseInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddDrivingLicenseInfoFragment_GeneratedInjector) this.generatedComponent()).injectAddDrivingLicenseInfoFragment(UnsafeCasts.<AddDrivingLicenseInfoFragment>unsafeCast(this));
    }
  }
