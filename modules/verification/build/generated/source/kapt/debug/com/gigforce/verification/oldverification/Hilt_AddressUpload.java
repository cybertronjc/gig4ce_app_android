...
public abstract class Hilt_AddressUpload extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddressUpload_GeneratedInjector) this.generatedComponent()).injectAddressUpload(UnsafeCasts.<AddressUpload>unsafeCast(this));
    }
  }
