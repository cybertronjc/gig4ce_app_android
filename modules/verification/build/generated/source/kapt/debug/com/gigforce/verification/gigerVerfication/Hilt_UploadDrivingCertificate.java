...
public abstract class Hilt_UploadDrivingCertificate extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UploadDrivingCertificate() {
    super();
  }

  Hilt_UploadDrivingCertificate(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadDrivingCertificate_GeneratedInjector) this.generatedComponent()).injectUploadDrivingCertificate(UnsafeCasts.<UploadDrivingCertificate>unsafeCast(this));
    }
  }
