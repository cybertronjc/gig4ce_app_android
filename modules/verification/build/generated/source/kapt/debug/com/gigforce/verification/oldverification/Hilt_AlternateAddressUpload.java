...
public abstract class Hilt_AlternateAddressUpload extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlternateAddressUpload() {
    super();
  }

  Hilt_AlternateAddressUpload(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlternateAddressUpload_GeneratedInjector) this.generatedComponent()).injectAlternateAddressUpload(UnsafeCasts.<AlternateAddressUpload>unsafeCast(this));
    }
  }
