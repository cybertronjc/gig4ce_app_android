...
public abstract class Hilt_Verification extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Verification(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Verification_GeneratedInjector) this.generatedComponent()).injectVerification(UnsafeCasts.<Verification>unsafeCast(this));
    }
  }
