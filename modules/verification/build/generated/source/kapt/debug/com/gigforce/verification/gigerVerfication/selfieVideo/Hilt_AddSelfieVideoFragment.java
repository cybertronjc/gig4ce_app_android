...
public abstract class Hilt_AddSelfieVideoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddSelfieVideoFragment() {
    super();
  }

  Hilt_AddSelfieVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddSelfieVideoFragment_GeneratedInjector) this.generatedComponent()).injectAddSelfieVideoFragment(UnsafeCasts.<AddSelfieVideoFragment>unsafeCast(this));
    }
  }
