...
public abstract class Hilt_AddAadharCardInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddAadharCardInfoFragment() {
    super();
  }

  Hilt_AddAadharCardInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAadharCardInfoFragment_GeneratedInjector) this.generatedComponent()).injectAddAadharCardInfoFragment(UnsafeCasts.<AddAadharCardInfoFragment>unsafeCast(this));
    }
  }
