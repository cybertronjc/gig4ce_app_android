...
public abstract class Hilt_AddBankDetailsInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddBankDetailsInfoFragment() {
    super();
  }

  Hilt_AddBankDetailsInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddBankDetailsInfoFragment_GeneratedInjector) this.generatedComponent()).injectAddBankDetailsInfoFragment(UnsafeCasts.<AddBankDetailsInfoFragment>unsafeCast(this));
    }
  }
