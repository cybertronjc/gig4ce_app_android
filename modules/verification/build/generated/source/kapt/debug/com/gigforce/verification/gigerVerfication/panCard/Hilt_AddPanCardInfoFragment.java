...
public abstract class Hilt_AddPanCardInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddPanCardInfoFragment() {
    super();
  }

  Hilt_AddPanCardInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddPanCardInfoFragment_GeneratedInjector) this.generatedComponent()).injectAddPanCardInfoFragment(UnsafeCasts.<AddPanCardInfoFragment>unsafeCast(this));
    }
  }
