...
public abstract class Hilt_PanUpload extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PanUpload(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PanUpload_GeneratedInjector) this.generatedComponent()).injectPanUpload(UnsafeCasts.<PanUpload>unsafeCast(this));
    }
  }
