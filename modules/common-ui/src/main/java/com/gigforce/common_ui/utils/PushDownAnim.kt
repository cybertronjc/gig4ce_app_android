...
/**
 * Created by Rohit on 26/10/2018
 */
open class PushDownAnim private constructor(view: View) :
    PushDown {
    private val defaultScale: Float
    private var mode = MODE_SCALE
    private var pushScale =
        DEFAULT_PUSH_SCALE
    private var pushStatic =
        DEFAULT_PUSH_STATIC
    private var durationPush =
        DEFAULT_PUSH_DURATION
    private var durationRelease =
