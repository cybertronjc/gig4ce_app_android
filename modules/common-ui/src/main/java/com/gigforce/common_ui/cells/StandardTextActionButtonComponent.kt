...
class StandardTextActionButtonComponent(context: Context, attrs: AttributeSet?) : FrameLayout(context,attrs),
    IViewHolder {
    ...
    init {
        ...
        attrs?.let {
            val styledAttributes =
                context.obtainStyledAttributes(it, R.styleable.StandardTextActionButtonComponent, 0, 0)
            val text = styledAttributes.getBoolean(
                R.styleable.StandardTextActionButtonComponent_android_text,
                false
            )
            val buttonCaps = styledAttributes.getBoolean(
                R.styleable.StandardTextActionButtonComponent_android_textAllCaps,
                false
            )
