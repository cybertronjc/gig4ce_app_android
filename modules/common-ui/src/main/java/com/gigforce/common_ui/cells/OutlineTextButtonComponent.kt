...
class OutlineTextButtonComponent @JvmOverloads constructor(context: Context, attrs: AttributeSet?) :
    ...
    init {
        ...
        attrs?.let {
            val styledAttributes =
                context.obtainStyledAttributes(it, R.styleable.OutlineTextButtonComponent, 0, 0)
            val buttonText =
                styledAttributes.getString(R.styleable.OutlineTextButtonComponent_android_text) ?: ""
            val buttonCaps = styledAttributes.getBoolean(
                R.styleable.OutlineTextButtonComponent_android_textAllCaps,
                false
            )
            text = buttonText
