...
open class TabType1CardView(
    ...
    private var viewDataType1: CustomTabDataType1? = null
    ...
    override fun bind(data: Any?) {
        (data as CustomTabDataType1).apply {
            viewDataType1 = this
    ...
    override fun onClick(v: View?) {
        viewDataType1?.viewModel?.handleCustomTabClick(viewDataType1!!)
    }
