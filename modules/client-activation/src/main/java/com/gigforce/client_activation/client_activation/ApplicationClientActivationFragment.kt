...
import com.gigforce.core.core.base.BaseFragment
import com.gigforce.core.extensions.gone
import com.gigforce.core.extensions.visible
import com.gigforce.core.navigation.INavigation
import com.gigforce.core.utils.getCircularProgressDrawable
...
class ApplicationClientActivationFragment : BaseFragment(),
    ...
    private fun initObservers() {
        ...
        viewModel.observableApplicationStatus.observe(viewLifecycleOwner, Observer {
            ...
            navigationDire.navigateTo("client_activation/gigActivation",bundleOf(
        ...
        for (i in adapter.items.indices) {
            if (!adapter.items[i].isDone) {
                when (adapter.items[i].type) {
                    "profile_pic" -> {
                        navigationDire.navigateTo("client_activation/profileFragment",bundleOf(
...
//                        )
                    ...
                    "about_me" -> {
                        ...
                        navigationDire.navigateTo("client_activation/addBio",bundleOf(
                            StringConstants.FROM_CLIENT_ACTIVATON.value to true
                        ))
...
//                        )
                    ...
                    "questionnaire" -> navigationDire.navigateTo("client_activation/applicationQuestionnaire",bundleOf(
                        StringConstants.JOB_PROFILE_ID.value to mJobProfileId,
                    ...
                    "driving_licence" ->
                    navigationDire.navigateTo("uploadDLScreen",bundleOf(StringConstants.FROM_CLIENT_ACTIVATON.value to true))
//                        navigate(
//                            R.id.fragment_upload_dl_cl_act,
//
//                    )
                    "learning" ->navigationDire.navigateTo("learningCourseDetails",bundleOf(
...
//                )
            ...
            "questionnaire" ->
                navigationDire.navigateTo("client_activation/applicationQuestionnaire",bundleOf(
                    StringConstants.JOB_PROFILE_ID.value to mJobProfileId,
...
//            )
//            )
            "driving_licence" -> navigationDire.navigateTo("client_activation/uploadDLScreen",bundleOf(StringConstants.FROM_CLIENT_ACTIVATON.value to true))

//            navigate(
//                    R.id.fragment_upload_dl_cl_act,
//                    bundleOf(StringConstants.FROM_CLIENT_ACTIVATON.value to true)
//            )
            "learning" -> navigationDire.navigateTo("client_activation/learningCourseDetails",bundleOf(
