...
import com.gigforce.app.modules.learning.learningVideo.*
...
class PlayVideoDialogFragment : DialogFragment(), RateLessonDialogFragmentClosingListener {
    @Inject
    lateinit var navigationDire : INavigation
                ...
                override fun actionClick() {
                    ...
                    when (nextLessonContent?.type) {
                        ...
                        CourseContent.TYPE_ASSESSMENT -> {
                            ...
                            navigationDire.navigateTo("client_activation/assessment",bundleOf(
                                INTENT_LESSON_ID to nextLessonContent!!.id,
                               INTENT_MODULE_ID to nextLessonContent!!.moduleId
                            ))
...
//                            )
                        ...
                        CourseContent.TYPE_SLIDE -> {
                            navigationDire.navigateTo("client_activation/slidesScreen",bundleOf(
                                INTENT_EXTRA_SLIDE_TITLE to nextLessonContent!!.title,
                                INTENT_EXTRA_MODULE_ID to nextLessonContent!!.moduleId,
                                INTENT_EXTRA_LESSON_ID to nextLessonContent!!.id
                            ))
...
//                            )
    ...
    private fun clearBackStackToContentList() {
        try {
            navigationDire.getBackStackEntry("client_activation/assessmentListFragment")
            navigationDire.popBackStack("client_activation/assessmentListFragment")
...
//            navigationController.popBackStack(R.id.assessmentListFragment, false)
            ...
            try {
                navigationDire.getBackStackEntry("client_activation/courseContentListFragment")
                navigationDire.popBackStack("client_activation/courseContentListFragment")
...
//                navigationController.popBackStack(R.id.courseContentListFragment, false)
                ...
                try {
                    ...
                    navigationDire.getBackStackEntry("client_activation/learningCourseDetails")
                    navigationDire.popBackStack("client_activation/learningCourseDetails")
...
//                    navigationController.popBackStack(R.id.learningCourseDetails, false)
                    ...
                    try {
                        navigationDire.getBackStackEntry("client_activation/mainLearningFragment")
                        navigationDire.popBackStack("client_activation/mainLearningFragment")
