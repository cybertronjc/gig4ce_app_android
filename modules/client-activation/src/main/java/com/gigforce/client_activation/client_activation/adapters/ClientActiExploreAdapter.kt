...
//        private var divider_one: View = itemView.findViewById(R.id.divider_one)
        private var jobProfileCard: JobProfileCardComponent = itemView.findViewById(R.id.jobProfileCard)
...
//            }
            jobProfileCard.setOnApplyNowClickListener(object : ApplyNowClickListener {
                override fun onApplyNowClicked(v: View, text: String) {
                    clientActiExploreList.takeAction(text, jobProfile.profileId, jobProfile.jobProfileTitle)
                }
            })
        }
