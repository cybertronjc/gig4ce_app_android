        ...
        gigerInfo.let {
            ...
            if (it.checkList == null){
                ...
                it.forEachIndexed { index, checkListItem ->
                    val itemData = ApplicationChecklistRecyclerItemData.ApplicationChecklistItemData(checkListItem.name, checkListItem.status, checkListItem.optional, checkListItem.frontImage , checkListItem.backImage,checkListItem.type,checkListItem.dependency)
