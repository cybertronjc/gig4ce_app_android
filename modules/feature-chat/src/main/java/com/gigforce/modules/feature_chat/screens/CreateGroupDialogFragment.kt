        ...
        chatGroupViewModel.createGroup
                .observe(viewLifecycleOwner, Observer {
                    ...
                    when (it) {
                        ...
                        is Lce.Content -> {
                            Toast.makeText(requireContext(), getString(R.string.group_created), Toast.LENGTH_LONG).show()
                        ...
                        is Lce.Error -> {
                            ...
                            MaterialAlertDialogBuilder(requireContext())
                                    ...
                                    .setMessage(getString(R.string.unable_to_create_group) + it.error)
    ...
    private fun initView(view: View) {
        ...
        submitBtn.setOnClickListener {
            ...
            if (groupNameET.length() == 0) {
                Toast.makeText(requireContext(), getString(R.string.enter_a_group_name), Toast.LENGTH_SHORT).show()
            } else {
                chatGroupViewModel.createGroup(
