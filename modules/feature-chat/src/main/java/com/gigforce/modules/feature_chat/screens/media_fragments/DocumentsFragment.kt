...
class DocumentsFragment : Fragment() {
    ...
    companion object {
        ...
        const val TAG = "DocumentsFragment"
    ...
    var selectedTab = 0
    private lateinit var viewBinding: FragmentDocumentsBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentDocumentsBinding.inflate(inflater, container, false)
