...
import com.gigforce.modules.feature_chat.databinding.RecyclerItemDateHeaderBinding
import com.gigforce.modules.feature_chat.databinding.RecyclerItemMediaBinding
import com.gigforce.modules.feature_chat.mediapicker.interfaces.MediaClickInterface
import com.gigforce.modules.feature_chat.mediapicker.utils.GeneralUtils.getScreenWidth
...
class BottomSheetMediaRecyclerAdapter(private val mMediaList: ArrayList<MediaModel>, val mInterface: MediaClickInterface, val mContext: Context):
    ...
    init {
        val size: Int = getScreenWidth(mContext as Activity) / SPAN_COUNT - MARGIN / 2
