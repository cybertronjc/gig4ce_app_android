...
public abstract class Hilt_PaymentDisputePage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentDisputePage_GeneratedInjector) this.generatedComponent()).injectPaymentDisputePage(UnsafeCasts.<PaymentDisputePage>unsafeCast(this));
    }
  }
