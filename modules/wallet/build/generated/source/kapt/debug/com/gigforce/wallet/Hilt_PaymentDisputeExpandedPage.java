...
public abstract class Hilt_PaymentDisputeExpandedPage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentDisputeExpandedPage_GeneratedInjector) this.generatedComponent()).injectPaymentDisputeExpandedPage(UnsafeCasts.<PaymentDisputeExpandedPage>unsafeCast(this));
    }
  }
