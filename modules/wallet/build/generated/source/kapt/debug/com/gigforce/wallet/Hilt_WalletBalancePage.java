...
public abstract class Hilt_WalletBalancePage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WalletBalancePage_GeneratedInjector) this.generatedComponent()).injectWalletBalancePage(UnsafeCasts.<WalletBalancePage>unsafeCast(this));
    }
  }
