...
public abstract class Hilt_WalletExpandedPage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WalletExpandedPage_GeneratedInjector) this.generatedComponent()).injectWalletExpandedPage(UnsafeCasts.<WalletExpandedPage>unsafeCast(this));
    }
  }
