...
public abstract class Hilt_MonthlyEarningPage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MonthlyEarningPage_GeneratedInjector) this.generatedComponent()).injectMonthlyEarningPage(UnsafeCasts.<MonthlyEarningPage>unsafeCast(this));
    }
  }
