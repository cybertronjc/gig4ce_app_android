...
public abstract class Hilt_InvoiceStatusPage extends WalletBaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InvoiceStatusPage_GeneratedInjector) this.generatedComponent()).injectInvoiceStatusPage(UnsafeCasts.<InvoiceStatusPage>unsafeCast(this));
    }
  }
