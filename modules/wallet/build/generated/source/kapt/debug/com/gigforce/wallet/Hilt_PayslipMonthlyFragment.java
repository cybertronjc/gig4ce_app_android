...
public abstract class Hilt_PayslipMonthlyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PayslipMonthlyFragment() {
    super();
  }

  Hilt_PayslipMonthlyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PayslipMonthlyFragment_GeneratedInjector) this.generatedComponent()).injectPayslipMonthlyFragment(UnsafeCasts.<PayslipMonthlyFragment>unsafeCast(this));
    }
  }
