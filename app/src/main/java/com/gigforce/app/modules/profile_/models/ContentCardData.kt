...
import com.gigforce.user_profile.components.ClickHandler
...
data class ContentCardData(@get:DrawableRes var topIcon: Int? = null, @get:StringRes var topLabel: Int? = null,
                           ...
                           @get:StringRes var contentText: Int? = null, @get:StringRes var actionText: Int? = null, var clickHandler: ClickHandler? = null)