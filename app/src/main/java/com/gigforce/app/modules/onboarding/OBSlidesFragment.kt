 ...
 * Use the [OBSlidesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OBSlidesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ob_slides, container, false)
    }
    ...
    fun setupViewPager(){
        this.viewpager.adapter = OBSlidesViewPagerAdapter(this.viewpager, object: OnOBSlidesCompleted(){

            override fun invoke() {
                this@OBSlidesFragment.findNavController().navigate(getResourceToNavigateTo())
            }
        })
...
class OBSlidesViewPagerAdapter(val viewpager:ViewPager2,
                                  val onOBSlidesCompleted: OnOBSlidesCompleted): RecyclerView.Adapter<OBSlidesViewPagerAdapter.ViewHolder>(){

    class ViewHolder(view:View,
                     val viewpager:ViewPager2,
                     val onOBSlidesCompleted: OnOBSlidesCompleted):RecyclerView.ViewHolder(view) {
        ...
        fun Bind(position: Int){
            ...
            if(position == 0) {
                ...
                titleTextView.setText(R.string.ob_slide1_title)
                subTitleTextView.setText(R.string.ob_slide1_subtitle)
                ...
                titleTextView.setText(R.string.ob_slide2_title)
                subTitleTextView.setText(R.string.ob_slide2_subtitle)
                nextButton.setText("next")
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(view, viewpager, onOBSlidesCompleted)
    }
