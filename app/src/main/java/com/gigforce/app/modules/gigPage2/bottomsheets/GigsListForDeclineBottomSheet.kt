    ...
    override fun onMessageClicked(gig: Gig) {
        ...
        if (gig.agencyContact != null && gig.agencyContact?.uid != null) {
            ...
            findNavController().navigate(
                    ...
                    ChatPageFragment.INTENT_EXTRA_OTHER_USER_ID to gig.agencyContact?.uid,
                    ChatPageFragment.INTENT_EXTRA_CHAT_HEADER_ID to "",
                    ChatPageFragment.INTENT_EXTRA_OTHER_USER_NAME to userName,
                    ChatPageFragment.INTENT_EXTRA_OTHER_USER_IMAGE to profilePicture
            )
            )
        }
    }
